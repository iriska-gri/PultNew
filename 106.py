...
class load106(Orm):
    ...
    def spravkaNalihie(self):
        dfspravka = orm.mySQL(orm.Selected('task_step_name', 'sprav_task_step_name'), self.myBD)
        massa = dfspravka.values
        dano = ['пусто']
        # print(massa)
        # if dano in dfspravka:
        #     print(dano)
        # stolb = pd.unique(self.csv_df[3])
