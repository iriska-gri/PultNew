...
class Ui_finished(object):
    def setupUi(self, finished):
        ...
        self.pushButton.setGeometry(QtCore.QRect(100, 170, 141, 23))
        ...
        self.label.setGeometry(QtCore.QRect(130, 40, 71, 51))
    ...
    def retranslateUi(self, finished):
        ...
        self.label.setText(_translate("finished", "Ты молодец"))
